import React from 'react'
    import { ArrowRight, Activity, Award, BarChart, Heart, Lightbulb, ShieldCheck } from 'lucide-react'
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-gray-50 rounded-lg shadow-md p-6">
                  ...
                  <p className="text-gray-600">
                    Automatically record your exercises with details like distance, duration, and date.
                  </p>
                </div>
                <div className="bg-gray-50 rounded-lg shadow-md p-6">
                  <div className="flex justify-center mb-4">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  ...
                  <p className="text-gray-600">
                    Simply create an account and start tracking your exercises.
                  </p>
                </div>
              </div>
            </div>
